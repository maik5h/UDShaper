...
static void GUIPaint(UDShaper *plugin, bool internal) {
	if (plugin->gui){
...
static void GUICreate(UDShaper *plugin) {
	plugin->gui = new GUI();
...
static void GUIDestroy(UDShaper *plugin) {
	assert(plugin->gui);
...
static void GUIOnPOSIXFD(UDShaper *) {}